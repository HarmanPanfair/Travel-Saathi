...
parameters.put("MID","Travel34615244140160");
parameters.put("CHANNEL_ID","WEB");
parameters.put("INDUSTRY_TYPE_ID","Retail");
parameters.put("WEBSITE","WEB_STAGING");
parameters.put("MOBILE_NO","9876543210");
parameters.put("EMAIL","test@gmail.com");
parameters.put("CALLBACK_URL", "http://localhost:8080/Travel_Sathi/pgResponse.jsp");


String checkSum =  CheckSumServiceHelper.getCheckSumServiceHelper().genrateCheckSum("JFs#E!HpB7J3jm0z", parameters);
